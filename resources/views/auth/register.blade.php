...
<div class="form-group">
  ...
  <input class="form-control" placeholder="Confirmar Contraseña" type="password" name="password" required>
</div>
</div>

<div class="text-center">
  <button type="submit" class="btn btn-primary mt-4"  name="password_confirmation" required>Confirmar resgitro</button>
</div>
</form>
</div>
</div>
